...
export const SECTIONS: ClusterConfig[] = [
  ...
  { id: 'projects', label: 'Proyectos', shape: 'grid', color: '#33FF77', seed: 7, count: 6000, position: [-4, 0, -4] },
  { id: 'testimonials', label: 'Testimonios', shape: 'orbit', color: '#9DFFC0', seed: 8, count: 4000, position: [0, -4, -4] },
